...
<head>
    ...
    <title>Bienvenidos a Nuestro Proyecto</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>

<div class="container">
    <h1>Análisis de la Población de Jugadores de MMORPGs en Steam</h1>
    <p>Realizamos un análisis de datos sobre la población de jugadores de MMORPGs en Steam para identificar patrones de comportamiento y tendencias.</p>
